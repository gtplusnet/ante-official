...
-- Insert test guardian
INSERT INTO "Guardian" (id, "firstName", "lastName", "dateOfBirth", email, password, key, "contactNumber", "companyId", "createdAt", "updatedAt")
VALUES 
  ('650e8400-e29b-41d4-a716-446655440001', 'Robert', 'Doe', '1980-01-01', 'robert.doe@email.com', 'hashed_password', E'\\x0123456789ABCDEF', '+1234567890', 999, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;