<template>
  <div class="overtime-filing-display">
    <!-- Header Section -->
    <div class="filing-header">
      <div class="row items-center q-gutter-sm">
        <q-icon name="alarm_add" size="24px" style="color: #FB8C00" />
        <div class="text-h6">Overtime Request</div>
      </div>
    </div>
    ...
    <div class="info-section">
      ...
      <div class="info-row row items-center">
        ...
        <div class="info-value">
          <strong class="text-primary">{{ filing.hours || 0 }} hours</strong>
        </div>
      </div>
    </div>

    <!-- Time Information Section -->
    <div class="info-section" v-if="filing.timeIn || filing.timeOut">
