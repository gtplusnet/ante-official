import { DeductionCategory, DeductionPeriod } from '@/types/prisma-enums';
...
export interface UpdateDeductionConfigurationRequest extends CreateDeductionConfigurationRequest {
  id: number;
}
...
export interface UpdateDeductionPlanConfigurationRequest extends CreateDeductionPlanConfigurationRequest {
  id: number;
}
