<template>
  ...
  >
    <TemplateDialog
      ...
      :scrollable="true"
    >
      <template #DialogTitle>Time History</template>
            ...
            <q-card-section class="q-pa-sm">
              <div class="row items-center">
                <div class="col">
                  ...
                  <div class="text-h6">
                    {{ formatDuration(dailySummary.totalMinutes * 60) }}
                  </div>
                </div>
                <div class="col-auto">
            ...
            >
              ...
              <q-item-section>
                ...
                <q-item-label caption class="q-mt-xs">
                  ...
                  <div
                    class="row items-center q-gutter-x-xs q-mt-xs location-row"
                  >
                    <q-icon
                      name="location_on"
                      size="12px"
                    ...
                    <span class="q-ml-sm"
                      >IP: {{ entry.timeInIpAddress || "N/A" }}</span
                    >
                  </div>
                </q-item-label>
                ...
                <q-item-label caption class="q-mt-sm">
                  ...
                  >
                    ...
                    <span class="q-ml-sm"
                      >IP: {{ entry.timeOutIpAddress || "N/A" }}</span
                    >
                  </div>
                </q-item-label>
              </q-item-section>
