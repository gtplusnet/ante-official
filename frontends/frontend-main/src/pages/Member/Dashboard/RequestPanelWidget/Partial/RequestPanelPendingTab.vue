<template>
  <div>
    ...
    <div v-else-if="filings.length === 0" class="q-pa-xl text-center text-label-medium text-grey">No pending requests</div>
...
const loadData = async () => {
  const result = await fetchFilings('PENDING', props.page - 1, props.rowsPerPage);
