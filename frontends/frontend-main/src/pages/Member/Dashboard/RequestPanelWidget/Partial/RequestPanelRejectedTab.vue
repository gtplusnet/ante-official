<template>
  <div>
    ...
    <div v-else-if="filings.length === 0" class="text-center q-pa-xl text-grey text-label-medium">No rejected requests</div>
...
const loadData = async () => {
  const result = await fetchFilings('REJECTED', props.page - 1, props.rowsPerPage);
