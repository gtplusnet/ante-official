  ...
  <expanded-nav-page-container>
    <div class="page-header q-mb-md">
      <div class="row items-start justify-between">
        <div class="col-grow">
          <h1 class="page-title">Guardian API Documentation</h1>
          <p class="page-subtitle text-grey-7">
            Complete API reference for guardian mobile applications and student management
          </p>
        </div>
        <div class="col-auto">
...
const documentationUrl = computed(() => {
  ...
  return `${baseUrl}/api/public/school-guardian`;
});
