  ...
  <expanded-nav-page-container>
    <div class="page-header q-mb-md">
      <div class="row items-start justify-between">
        <div class="col-grow">
          <h1 class="page-title">Manpower API Documentation</h1>
          <p class="page-subtitle text-grey-7">
            Complete API reference for time tracking devices and biometric integration
          </p>
        </div>
        <div class="col-auto">
      ...
      <q-card-section class="q-pa-none">
        <div class="iframe-container">
          <iframe
            ...
            title="Manpower API Documentation"
            frameborder="0"
            allowfullscreen
          />
        </div>
