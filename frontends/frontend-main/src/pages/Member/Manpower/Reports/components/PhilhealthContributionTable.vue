<template>
  <div class="philhealth-contribution-table">
      ...
      >
        ...
        <template v-slot:header>
          <q-tr class="table-header-row">
            ...
            <q-th class="text-body-medium text-weight-medium">Basis Amount</q-th>
            <q-th class="text-body-medium text-weight-medium">Employee Share</q-th>
            <q-th class="text-body-medium text-weight-medium">Employer Share</q-th>
            <q-th class="text-body-medium text-weight-medium">Total</q-th>
        ...
        <template v-slot:no-data>
          <div class="no-data-container">
            <div class="column items-center">
              ...
              <div class="text-title-large text-grey q-mt-sm">No PhilHealth contribution records found</div>
...
interface PhilhealthContributionRow {
  id: number;
  employeeCode: string;
  employeeName: string;
  branch: string;
...
const props = defineProps({
  ...
  rows: {
    type: Array as PropType<PhilhealthContributionRow[]>,
    default: () => [],
  },
  loading: {
    type: Boolean,
...
const exportToExcel = () => {
  ...
  ws['!cols'] = [
    ...
    { wpx: 120 },  // Employee Share
    { wpx: 120 },  // Employer Share
    { wpx: 120 },  // Total
    { wpx: 120 }   // Date Posted
  ];
  ...
  const filename = `PhilHealth-Contributions-${date}.xlsx`;
