<template>
  <div class="pagibig-contribution-table">
        ...
        <template v-slot:no-data>
          <div class="no-data-container">
            <div class="column items-center">
              ...
              <div class="text-title-large text-grey q-mt-sm">No Pag-IBIG contribution records found</div>
...
interface PagibigContributionRow {
  id: number;
  employeeCode: string;
  employeeName: string;
  branch: string;
...
const props = defineProps({
  ...
  rows: {
    type: Array as PropType<PagibigContributionRow[]>,
    default: () => [],
  },
  loading: {
    type: Boolean,
...
const exportToExcel = () => {
  ...
  const filename = `Pagibig-Contributions-${date}.xlsx`;
