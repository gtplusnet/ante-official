<template>
  <expanded-nav-page-container>
    <div class="page-head">
      <div class="title text-headline-small">Temporary Warehouse</div>
    </div>
    <div class="bread-crumbs text-body-small">
      <q-breadcrumbs>
        ...
        <q-breadcrumbs-el label="Temporary Warehouse" />
      </q-breadcrumbs>
    </div>
    ...
    <add-edit-warehouse-dialog :warehouseType="'TEMPORARY_WAREHOUSE'" @close="this.$refs.gTable.refetch()"
...
export default {
  name: 'MemberAssetTemporaryWarehouse',
  components: {
