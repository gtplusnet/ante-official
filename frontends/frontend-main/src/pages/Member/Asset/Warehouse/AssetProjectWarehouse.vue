<template>
  <expanded-nav-page-container>
    <div class="page-head">
      <div class="title text-headline-small">Project Warehouse</div>
    </div>
    <div class="bread-crumbs text-body-small">
      <q-breadcrumbs>
        ...
        <q-breadcrumbs-el label="Project Warehouse" />
      </q-breadcrumbs>
    </div>
    <div class="page-content">
      ...
      <g-card class="q-pa-md q-mt-sm text-body-small">
        <g-table ref="gTable" :isRowActionEnabled="true" tableKey="warehouseProject" 
          apiUrl="/warehouse" :apiFilters="[{ deleted: false, warehouseType: 'PROJECT_WAREHOUSE' }]">
    ...
    <add-edit-warehouse-dialog :warehouseType="'PROJECT_WAREHOUSE'" @close="this.$refs.gTable.refetch()"
...
export default {
  name: 'MemberAssetProjectWarehouse',
  components: {
